...
await conn.sendButton(m.chat, `*「 Corra Membro comum, O ban está próximo... 」*\n*${await this.getName(m.sender)} 𝙽𝙾𝚂 𝚅𝙴𝙼𝙾𝚂 :)*${isBotAdmin ? '' : '\n\n*[❗𝐈𝐍𝐅𝐎❗] 𝙴𝙻 𝙱𝙾𝚃 𝙽𝙴𝙲𝙴𝚂𝙸𝚃𝙰 𝚂𝙴𝚁 𝙰𝙳𝙼𝙸𝙽𝙸𝚂𝚃𝚁𝙰𝙳𝙾𝚁*'}`, author, ['𝙳𝙴𝚂𝙰𝙲𝚃𝙸𝚅𝙰𝚁 𝙰𝙽𝚃𝙸𝙻𝙸𝙽𝙺𝚂', '/ttp you are an idiot  🙂🙂🙂'], m)    
